...
The frontend chat interface visualizes this entire process, showing the agent's "thoughts" and tool calls in real-time as they happen. This is the link to the deployed demo: [Demo Link](https://chatbot-agent-cb3y.onrender.com) Note that due to deploying on a free tier, the application goes to sleep after 15 minutes of inactivity. So it may take a few minutes to starup again.
